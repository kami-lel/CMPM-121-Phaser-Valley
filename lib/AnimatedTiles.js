    ...
    */
          ...
          _createClass(AnimatedTiles, [{
            ...
            value: function setRate(rate) {
              var gid = arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : null;
            ...
            value: function resetRates() {
              var mapIndex = arguments.length > 0 && arguments[0] !== undefined
                ? arguments[0]
                : null;
            ...
            value: function resume() {
              ...
              var layerIndex =
                arguments.length > 0 && arguments[0] !== undefined
                  ? arguments[0]
                  : null;
              var mapIndex = arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
                : null;

              var scope = mapIndex === null
                ? this
            ...
            value: function postUpdate(time, delta) {
              ...
              var globalElapsedTime = delta * this.rate *
            ...
            value: function updateLayer(animatedTile, layer) {
              var oldTileId = arguments.length > 2 && arguments[2] !== undefined
                ? arguments[2]
                : -1;
              ...
              layer.forEach(function (tile) {
                ...
                if (
                  oldTileId > -1 && (tile === null || tile.index !== oldTileId)
                ) {
                  ...
                  Object.keys(tileData).forEach(function (index) {
                    ...
                    if (tileData[index].hasOwnProperty("animation")) {
                      ...
                      map.layers.forEach(function (layer) {
                        if (
                          (!layer.tilemapLayer) || (!layer.tilemapLayer.type) ||
                    ...
                    for (var _x9 = chkX; _x9 < chkX + chkW; _x9++) {
                      for (var _y = chkY; _y < chkY + chkH; _y++) {
                        ...
                        if (tile.index == tileAnimData.index) {
                          ...
                          tile.index =
                            tileAnimData.frames[tileAnimData.currentFrame]
                              .tileid;
                        }
                      }
                    }
